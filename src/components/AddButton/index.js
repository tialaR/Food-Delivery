...
const AddButton = ({ onAddPress, onDecreasePress }) => {
  ...
  return (
    <Container>
      <Decrease
        onPress={() => {
          setAddDecrease(addDecrease !== 1 ? addDecrease - 1 : 1);
          onDecreasePress(addDecrease !== 1 ? addDecrease - 1 : 1);
        }}>
      ...
      <Add
        onPress={() => {
          ...
          onAddPress(addDecrease < 50 ? addDecrease + 1 : addDecrease);
        }}>
        <AddTxt>+</AddTxt>
      </Add>
    </Container>
